...
- Tuned the trot toward a more heads-up dog posture: reduced persistent twist with stronger upright/lateral correction, balanced front/rear support, sharpened the vertical step pulse for a bit more bob, and made idle turning strong enough to work from zero velocity.
